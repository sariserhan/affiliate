    ...
    st.markdown(
        ...
        <div id="footer">
            <p>                                                 
                ...
                <br>
                <a style="text-decoration: none; filter: invert(50%)" href='aibestgoods.com/privacy' target='_blank' rel="noopener noreferrer">                    
                    Privacy Statement
                </a>              
                <a style="display: inline-block; margin-left: 10px; text-decoration: none; filter: invert(50%)" href='aibestgoods.com/terms-conditions' target='_blank' rel="noopener noreferrer">                    
