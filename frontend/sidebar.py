...
def get_sidebar() -> str:
    with st.sidebar:
        ...
        main_sidebar = option_menu(
            menu_title=None,
            options=['All Items', 'Ask AI', 'Compare Items with AI',
                     'Best Picks', 'Most Viewed', 'Pros & Cons']+category_list,
            icons=["list-stars", "question-square",
                   "arrow-left-right", "star", "bookmark-star", "yin-yang"]
        )
        return main_sidebar
